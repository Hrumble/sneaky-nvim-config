...
keymap.set("n", "<Leader>rn", function() vim.lsp.buf.rename() end,
	{ desc = "renames a function or variable in the entire project" })                                                              -- renames a function or variable in the entire project
keymap.set("n", "<S-u>", "<cmd>redo<cr>", { desc = "shift-u to redo undo" })                                                      -- shift-u to redo undo
keymap.set("n", "<Leader>ft", "<cmd>Telescope colorscheme<cr>", { desc = "browse available colorschemes with telescope" })        -- browse available colorschemes with telescope
keymap.set("n", "<Leader>ff", "<cmd>Telescope find_files<cr>", { desc = "browse files with telescope" })                          -- browse files with telescope
keymap.set("n", "<Leader>fc", "<cmd>Telescope commands<cr>", { desc =
"Opens a list of all available commands to the user" })                                                                           -- Opens a list of all available commands to the user
...
keymap.set("n", "<Leader>fs", "<cmd>Telescope lsp_document_symbols<cr>",
	{ desc = "browse current file definitions with telescope" })                                                                                    -- browse current file definitions with telescope
...
keymap.set("n", "<Bslash>", "<cmd>Neotree toggle left reveal<cr>", { desc = "Toggles neotree" })                                                  -- Toggles neotree
keymap.set("n", "<Leader>gd", "<cmd>Telescope lsp_definitions<cr>",
	{ desc = "goes to class or variable definition of word under cursor" })                                                                         -- goes to class or variable definition of word under cursor
keymap.set("n", "<Leader>gtd", "<cmd>Telescope lsp_type_definitions<cr>",
	{ desc = "goes to the definition of the *TYPE* of the word under cursor" })                                                                     -- goes to the definition of the *TYPE* of the word under cursor
